/*Sergio Alba y Andres Alvarez
 *EDA Curso 2021-2022
 * PRACTICA 1 PARTE 1
 */
/* LIBRER�AS#include <stdio.h> EST�NDAR*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
typedef struct Empresa{
    char Empresa[MAX_CARACTERES]; //lo he cambiado a puntero
    double Ingresos;
    double Gastos;
    double Variacion;
 } tEmpresa;
int main(void)         /* funcion o programa principal */
{
    ...
    char *fichero =FICH01;
        ...
        struct Empresa tEmpresa[elementos]; //creamos tEMpresa para guardar todas las empresas
        /*
...
return contador; //devolvemos el numero de lineas contadas
 ...
 void leerfichero(struct Empresa tEmpresa[],int elementos){
...
int contarperdidas(struct Empresa tEmpresa[],int elementos)
{
    int contador=0;
    for(int i=0;i<elementos;i++){
...
int contarganacias(struct Empresa tEmpresa[],int elementos)
{
...
void guardardatos(struct Empresa tEmpresa[],int elementos){
     FILE *pfich;  //declaramos puntero de tipo archivo
